...
import { 
  ...
  Star, ArrowRight, Check, Phone, Users, Mail, Calendar, TrendingUp,
  CreditCard, Shield, Rocket, Palette, Globe
} from 'lucide-react'
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
      {/* Floating Navigation - Keep existing header */}
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-white via-indigo-50/30 to-white">
        {/* Subtle floating elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-96 h-96 bg-indigo-100/40 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-purple-100/40 rounded-full blur-3xl"></div>
        </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-2xl text-lg font-semibold hover:shadow-xl transition-all shadow-lg"
                >
                  Probeer gratis
                </motion.a>
                <motion.a
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="bg-white text-indigo-600 px-8 py-4 rounded-2xl text-lg font-semibold border-2 border-indigo-600 hover:bg-indigo-50 transition-all"
                >
                  Bekijk demo
                </motion.a>
              </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <motion.div
            ...
            className="w-6 h-10 border-2 border-indigo-600 rounded-full flex justify-center"
          >
      ...
      <section id="features" className="py-24 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 transition-all duration-300"
            >
      ...
      <section className="py-24 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="order-1 lg:order-2 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-3xl p-8 flex items-center justify-center">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24"
          >
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-3xl p-8 flex items-center justify-center">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-3xl p-8 flex items-center justify-center">
              <div className="w-full max-w-sm">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
              ...
              <div className="w-full">
                <div className="grid grid-cols-3 gap-4">
                  {['Google', 'Outlook', 'Mollie', 'Calendar', 'Drive', 'Slack'].map((service, i) => (
                    <div key={i} className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md flex flex-col items-center hover:shadow-lg transition-shadow">
      ...
      {/* Testimonials */}
      <section className="py-24 bg-gradient-to-b from-indigo-50 to-white dark:from-indigo-900/20 dark:to-gray-900 transition-colors duration-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
